...
import styles from './ScienceStyle';
      ...
      >
        <SafeAreaView style={styles.formContainer}>
          ...
          <ScrollView contentContainerStyle={styles.formContent}>
            <Text style={styles.gradeText}>Grade {grade} - Science</Text>
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTxt}>Science Material</Text>
      </View>
      
      <ScrollView nestedScrollEnabled={true} contentContainerStyle={styles.scrollViewContent}>
        {grade ? (
          <View style={styles.gradeContainer}>
            <Text style={styles.gradeText}>{grade} - Science</Text>
