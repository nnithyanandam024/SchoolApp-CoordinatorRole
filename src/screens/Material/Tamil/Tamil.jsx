      ...
      >
        <SafeAreaView style={styles.formContainer}>
          ...
          <ScrollView contentContainerStyle={styles.formContent}>
            <Text style={styles.gradeText}>Grade {grade} - Tamil</Text>
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTxt}>Tamil Material</Text>
      </View>
      
      <ScrollView nestedScrollEnabled={true} contentContainerStyle={styles.scrollViewContent}>
        {grade ? (
          <View style={styles.gradeContainer}>
            <Text style={styles.gradeText}>{grade} - Tamil</Text>
